                            ...
                            if (isset($_GET['diachi'])) {
                                ...
                                foreach ($result as $arr) {
                                    ...
                                    <div class="d-flex justify-content-between p-2">
                                        <div class="info">
                                            <div class="name">' . $arr['name'] .($arr['loai']==1? '<a class="text-success text-decoration-none fs-6"> <i class="fa-solid fa-circle-check"></i>Địa chỉ mặc định</a>':''). '</div>
                                            <div class="address"><span>Địa chỉ: </span>' . $arr['addr'] . '</div>
                                            <div class="phone"><span>Điện thoại: </span>' . $arr['phone'] . '</div>
                                        </div>
                                        <div><a class="text-primary text-decoration-none fa-solid fa-pen-to-square fs-5" href="./sua_diachi.php?id_addr=' . $arr['id_addr'] . '"></a>
                                            <a class="btn text-danger btn-sm fa-solid fa-xmark fs-5" onclick="xoaDiaChi(this, ' . $arr['id_addr'] . ')"></a>
                                        </div>
                                    </div>
                                </div>';
                                }
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if (this.responseText == 'fail') {
                        ...
                        node.innerHTML = '<div class="d-flex justify-content-between p-2">' +
                            ...
                            '</div>' +
                            '<div>' +
                            '<a class="text-primary text-decoration-none fa-solid fa-pen-to-square fs-5" href="./sua_diachi.php?id_addr=' + s0 + '"></a>' +
                            '<a class="btn text-danger btn-sm fa-solid fa-xmark fs-5" onclick="xoaDiaChi(this, ' + s0 + ')"></a>' +
                            '</div>' +
                            '</div>'
